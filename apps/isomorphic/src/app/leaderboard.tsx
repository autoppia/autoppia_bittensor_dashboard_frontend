...
const CustomLabel = (props: any) => {
    ...
    return (
        <g>
            <text x={x + width + 25} y={y + height / 2} fill="#fff" textAnchor="middle" dominantBaseline="middle">
                {`${value}%`}
            </text>
        </g>
    );
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <YAxis
                            dataKey="framework"
                            type="category"
                            style={{ fontSize: 15, fontWeight: 500, fill: '#fff' }}
                            width={150}
                            axisLine={true}
                            tickLine={false}
                        />
                        ...
                        <Bar dataKey="percentage" fill="#3872FA" >
