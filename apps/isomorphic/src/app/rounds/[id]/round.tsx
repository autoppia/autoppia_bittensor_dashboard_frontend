    ...
    <div className="w-full max-w-[1600px] mx-auto">
      ...
      <div className="mt-6 flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-3 py-1.5 text-xs font-semibold text-black shadow-sm transition-shadow duration-150 hover:shadow-md"
        >
