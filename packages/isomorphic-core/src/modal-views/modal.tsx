...
const modalStyles = {
  ...
  overlay:
    "fixed inset-0 cursor-pointer bg-gradient-to-br from-blue-500/25 via-teal-500/18 to-indigo-500/25 backdrop-blur-sm z-10 duration-300 ease-in-out data-[closed]:opacity-0",
  panel:
